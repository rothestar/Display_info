...
config['DEFAULT'] = {"fan_frequency" : "80"}

config['DEFAULT'] = {"fan_set_temp" : "45"}

config['User'] = {"startscreen" : "0"}

config['User'] = {"fan_frequency" : "80"}

config['User'] = {"fan_set_temp" : "45"}

config['User'] = {"fan_pid_kp" : "-3"}

config['User'] = {"fan_pid_ki" : "-0.5"}

config['User'] = {"fan_pid_kd" : "-2.5"}
